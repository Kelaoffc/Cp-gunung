...
-- if _G.HohoVersion == "v3" or _G["Fumo Blox Fruit - Nixcooll Hub Kaitun V3"] or _G["Nixcooll Hub Auto Bounty V3"] or _G["Nixcooll Fruits Collector"] or _G.HOHO_PVP_UI or _G.HOHO_SERVER_ID then
	-- return loadstring(game:HttpGet("https://raw.githubusercontent.com/acsu123/HohoV2/Free/BloxFruitFreeV3.lua"))()
-- end

-- _G.HOHO_AD = {
-- 	[1] = {link="https://gcdnb.pbrd.co/images/AVitm37MSdIY.png", exp=tick()+9999, read = "t.me/nixsukakamu"},
-- }
local list = {
	--Adopt Me
...
--         Label.Text = "NIXCOOLL NCL (contact https://t.me/nixsukakamu) (auto close when 60s)"
--         Label.Parent = Back
...
--     -- GroupADS:CreateAds(GetImage("hohodiscord", "https://i.imgur.com/e2fdiZD.png"), "https://https://t.me/nixsukakamu")
-- end)
...
if list[game.GameId] ~= nil then
	...
	notify.New("This game is not supported by Nixcooll :(", 60)
	notify.New("Please join https://t.me/nixsukakamu to check what game r supported by us!", 60)
	notify.New("Running Nixcooll Universal Script!", 60)
	if game:GetService("CoreGui"):FindFirstChild("Nixcooll_раssсhесk") then
		game:GetService("CoreGui"):FindFirstChild("Nixcooll_раssсhесk"):Destroy()
	end
	_G.loadCustomId = "b358ee69695f62450471edf52317559a"
	loadstring(game:HttpGet("loadstring(game:HttpGet('https://pastebin.com/raw/f8gA1vhN""))()
end
-- if _G["Nixcooll Hub Auto Bounty V3"] or _G["Fumo Blox Fruit - Nixcooll Hub Kaitun V3"] then return end
-- local path = "wait(5);loadstring(game:HttpGet('https://pastebin.com/raw/f8gA1vhN"
-- if getgenv().Key then
