...
if not isSupport then
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Kelaoffc/Cp-gunung/refs/heads/main/hoho2.lua'))()
	wait(9e9)
end
...
do	
	...
	Get.MouseButton1Click:Connect(function()
		-- setclipboard('https://t.me/nixsukakamu' .. tick())
		setclipboard('https://besargaji.com/Lbf14r' .. tick())
		StarterGui:SetCore("SendNotification",{
			Title = "Key System",
    ...
    Get2.MouseButton1Click:Connect(function()
        setclipboard('https://youtu.be/zSjctk4jXAg?si=yT5uwjQgjpOwNaGs')
        StarterGui:SetCore("SendNotification",{
            Title = "Key System",
	...
	do
		if isfile("nixcooll.txt") or _G.MY_KEY_IS then
			local key = _G.MY_KEY_IS and _G.MY_KEY_IS or readfile("nixcooll.txt")
